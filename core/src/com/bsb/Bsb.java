		...
		public void render() {
			...
			if (estadodoJogo == 0 ){
				...
				if (estadodoJogo == 1) {
					...
					// Galinha
					batch.draw(galinha[(int)variacao],120,posicaoInicalvertical);
					...
					galinhaCirculo = new Circle(120 + galinha[0].getWidth()/2,posicaoInicalvertical + galinha[0].getHeight()/2 , galinha[0].getHeight()/2);
					covid1circulo = new Circle(movimentohorizontal +covid[0].getHeight()/2 ,(1800) + verticalRandomico + covid[0].getWidth()/2, covid[0].getHeight() );
					covid2circulo = new Circle(movimentohorizontal2 +covidemenor[0].getHeight()/2 ,(1000) + verticalRandomico + covidemenor[0].getWidth()/2, covidemenor[0].getHeight()/2);
					covid3circulo = new Circle(movimentohorizontal3 +covidmaior[0].getHeight()/2 ,(500) + verticalRandomico + covidmaior[0].getWidth()/2, covidmaior[0].getHeight()/2);
					covid4circulo = new Circle(movimentohorizontal4 +covidmedio[0].getHeight()/2 ,(50) + verticalRandomico + covidmedio[0].getWidth()/2, covidmedio[0].getHeight()/2);

					//desenhar formas

					galinhaCirculo.set(120 + galinha[0].getWidth()/2,posicaoInicalvertical + galinha[0].getHeight()/2 , galinha[0].getHeight()/2);
